    ...
    >
        <el-table-column type="expand">
            <template slot-scope="props">
                <el-button type="success" icon="el-icon-check" round @click="Save(props.row.UUID)">
                    Save
                </el-button>
                <el-button type="danger" icon="el-icon-delete" round @click="Delete(props.row.UUID)">
                    Delete
                </el-button>
    ...
    methods: {
        fetchData() {
            ...
            .then(res => {
                ...
                for (let server of res.data.tmpServers) {
                    var pushed = server
                    ...
                    if (timeStamp - pushed.lastTime > 30) {
                        ...
                        pushed.memoryRate = parseInt(pushed.memoryUsed/pushed.memoryTotal * 100)
                        pushed.diskRate = parseInt(pushed.diskUsed/pushed.diskTotal *  100)
